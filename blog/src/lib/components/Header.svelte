...
<header class="hdr">
  <div class="hdr-in">
    ...
    <div class="hdr-right">
      ...
      <a class="btn-ghost" href={MAIN_SITE} aria-label="metrale.ai">
        <span class="lbl">metrale.ai</span>
        <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.4" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">
          <path d="M7 17L17 7M17 7H8M17 7v9" />
        </svg>
      </a>
      <a class="btn-ghost" href={githubUrl} target="_blank" rel="noopener" aria-label="Metrale on GitHub">
        <GithubIcon size={14} />
      </a>
    </div>
  </div>

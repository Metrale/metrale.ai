...
export const SITE = 'https://blog.metrale.ai';
...
export const blog = {
  ...
  description:
    'Engineering notes from the Metrale inference engine: CUDA kernels, quantisation, ' +
...
export const authors = {
  'thomas-braun': {
    name: 'Thomas Braun',
    initials: 'TB',
    role: 'Founder, Metrale',
    bio: 'Works on the Metrale inference engine — kernels, scheduling, and the benchmarks that decide whether any of it was worth it.'
  },
  'ronald-stesiak': {
...
export const footerCols = [
  ...
  },
  {
    heading: 'Metrale',
    links: [
      { text: 'metrale.ai', href: MAIN_SITE },

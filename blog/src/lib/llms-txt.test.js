...
/**
 * All three properties publish llms.txt (https://llmstxt.org), and each points
 * at the other two. That cross-linking is the whole value: an agent that finds
 * one has no other way to discover the rest — none of the three hosts is
 * derivable from the others. The docs book lives in the engine's repository,
 * so its file is checked there; this repository holds the site's and the blog's.
 *

...
<svelte:head>
  <title>Control plane — Metrale</title>
  <meta
    name="description"
    content="Manage the Metrale agents on your own machines: node health, pairing, topology and multi-node launches. Everything stays on your LAN."
  />
</svelte:head>

...
export const mlcommons = {
  line:
    'Metrale is a member of MLCommons and sits on the Edge LLM taskforce, where we helped shape the new v6.1 edge agentic benchmark. MLCommons names us as a contributor in the announcement, under our former name, Atlas Inference.',
...
export const codeChat = {
  ...
  sub:
    'The whole Metrale repo is embedded into a vector lattice that runs right here in your browser. Ask a question, get an answer with file and line receipts.',
  boot: [

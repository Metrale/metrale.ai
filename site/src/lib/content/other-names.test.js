...
// point at where the open source history lives and the blog's redirect for one
// post's previous address.
...
const KEEP = new Set(['web-shared/sources.mjs', 'site/static/_redirects', 'blog/static/_redirects']);

...
export const story = {
  ...
  lede: 'In January 2026 a working improvement to llama.cpp was closed because it had been written with AI. The author wrote a short appeal to common sense, and when it went over everyone’s heads, answered the room with a question. Then he went and built the engine from scratch.',
  beats: [
    {
      when: 'January 7, 2026',
...
export const mission = {
  ...
  body: 'AI worth having should run on hardware you own, whether that is an accelerator at the edge, the workstation under your desk, or a rack you operate. We build one engine for the whole range, verify it on the silicon we can put our hands on, and make what it produces accountable to the people paying for it.',
  principles: [
    {
    ...
    },
    {
      ...
      body: 'Security, governance and economics are only exact when the engine is under the workload. Everything we build follows from that.',
    },
    {
...
export const team = {
  ...
  people: [
    ...
    },
    {
      ...
      cite: {
        text: 'US 12,224,993',
        label: 'The patent, US 12,224,993, on Google Patents',
        href: 'https://patents.google.com/patent/US12224993B2/en',
      },
    },
    {
      name: 'Eric Gonzalez',
...
export const careers = {
  ...
  benefits: [
    ...
    },
    {
      ...
      body: 'DGX Spark and Strix Halo are on the bench today, from NVIDIA and AMD. Hopper and Blackwell are the next campaigns.',
    },
    {
      title: 'The number is the argument',
      body: 'Every claim ships with the measurement behind it, including the rungs we lost on the way. Nobody wins a review by seniority.',
    },
    {
      title: 'Early enough to matter',
      body: 'The team is small enough that the first hires decide how the company works, not only what it builds.',
    },
  ],
...
export const contact = {
  ...
  paths: [
    ...
    // the job, not the person, so the card stays true when the person changes.
    {
      ...
      body: 'Enterprise, datacenter, air gapped or a fleet of boxes. Tell us the hardware and the workload and we scope the ladder.',
      doors: [{ label: 'Email sales', email: contacts.sales }],
      demo: true,
    },
    {
      title: 'Technical and open source',
      body: 'Running the open source engine, bringing hardware to the table, or want to contribute. Discord is fastest, email works.',
      doors: [{ label: 'Email engineering', email: contacts.engineering }],
      discord: true,
    },
    {
      title: 'Partnerships',
    ...
    },
    {
      ...
      doors: [{ label: 'Report privately', email: contacts.security }],
      href: links.securityPolicy,
    },
    {
      title: 'Press and investors',
      body: 'Deck, receipts and the verification walkthrough on request.',
      doors: [{ label: 'Email press and investors', email: contacts.press }],
    },
  ],
};
...
export const demoPage = {
  ...
  lede: 'A working session, not a slideshow. Tell us the hardware and the workload, and we come with the ladder ready to run on it. Thirty minutes to decide whether a four week proof of value is worth your time.',
  bullets: [
  ...
  form: {
    ...
    fields: [
      ...
      {
        name: 'hardware',
        label: 'Hardware you run inference on',
        type: 'text',
        placeholder: 'e.g. 64 H100, 2 DGX Spark, mixed NVIDIA and AMD',
      },
      {
        name: 'engine',
        label: 'Serving stack today',
        type: 'select',
        options: ['vLLM', 'SGLang', 'llama.cpp', 'TensorRT-LLM or NIM', 'A hosted API', 'None yet', 'Other'],
      },
      {
        name: 'notes',
        label: 'What you want to see',
        type: 'textarea',
        placeholder: 'The workload, the concurrency, the question you need answered',
      },
    ],
...
export const waitlistPage = {
  ...
  form: {
    ...
    fields: [
      ...
      {
        name: 'hardware',
        label: 'Hardware you would run it on',
        type: 'text',
        placeholder: 'e.g. DGX Spark, Strix Halo, 2 RTX 5090, 8 H100',
      },
      {
        name: 'use',
        label: 'You are',
        type: 'select',
        options: ['A developer', 'A research lab', 'A small business', 'An enterprise team', 'Something else'],
      },

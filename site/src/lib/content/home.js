...
export const chain = {
  ...
  steps: [
    { title: 'The engine earns the deployment', body: 'Nobody installs a governance layer for its own sake. Metrale gets into the fleet by making the same GPUs produce more inference.' },

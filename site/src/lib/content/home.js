...
export const logoWall = {
  ...
  programs: [
    ...
    { name: 'AMD', file: 'amd', fileDark: 'amd-dark', blurb: 'Strix Halo hardware provided. MLPerf submitted on it.' },
    {
      name: 'MLCommons',
      file: 'mlcommons',
      fileDark: 'mlcommons-dark',
      height: 32,
      href: links.mlcommons,
      blurb: 'Named contributor to the MLPerf edge agentic benchmark.',
    },
    {
      name: 'Hugging Face',
      file: 'huggingface',
      fileDark: 'huggingface-dark',
      height: 34,
      href: links.transformersPr,
      blurb: 'Fused Qwen GDN kernel merged into Transformers.',
    },
...
export const recognition = {
  ...
  cards: [
    {
      org: 'MLCommons',
      mark: { name: 'MLCommons', file: 'mlcommons', fileDark: 'mlcommons-dark', height: 32 },
      hue: 'green',
      date: 'July 2026',
      title: 'Named contributor to the MLPerf Inference v6.1 edge agentic benchmark',
      cta: 'Read the announcement',
      href: links.mlcommons,
    },
    {
      org: 'Hugging Face',
      mark: { name: 'Hugging Face', file: 'huggingface', fileDark: 'huggingface-dark', height: 34 },
      hue: 'gold',
      date: 'July 2026',
      title: 'Fused Qwen Gated DeltaNet kernel merged into Transformers',
    ...
    },
    {
      ...
      hue: 'cyan',
      date: 'July 2026',
      title: 'Strix Halo hardware provided. MLPerf v6.1 submitted from the same CUDA source',
      cta: 'See the post',
      href: links.x,
    },
    {

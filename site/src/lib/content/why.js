...
export const whyHero = {
  ...
  lede: 'Metrale models your inference economics first, then runs, governs and measures every workload against that model directly. A fundamentally different approach to getting more inference, and more accountability, from silicon you already own.',

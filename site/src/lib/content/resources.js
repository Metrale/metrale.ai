...
export const resourcesHub = {
  ...
  cards: [
    ...
    { title: 'Documentation', body: 'The Metrale book. Install, recipes, deployment, the control plane and the gates, with an llms.txt for answer engines.', href: links.docs, external: true, cta: 'Open the book' },
    ...
    { title: 'Metrale Labs', body: 'The research arm. Kernels, compression, speculative decoding, protocols and the day zero model bring ups.', href: routes.labs, cta: 'See the research' },
...
export const labs = {
  ...
  tracks: [
    ...
    { title: 'Day zero model bring up', body: 'DeepSeek V4.1 Flash, Kimi K3, GLM 5.3, Qwen 3.8 Flash Next and Gemma 4 in open pull requests. The goal is that model vendors check Metrale the same week they check vLLM.', color: 'green' },

...
export const audit = [
  ...
  },
  {
    ...
    answer:
      'Every number is served over the OpenAI HTTP path with a real client. No kernel-level timings are claimed as serving throughput.',
  },
  {
    state: 'clear',
  ...
  },
  {
    ...
    answer:
      'Everything here is self-run. That is exactly why the artifacts are pinned to the level an external auditor would ask for, and why we would rather you re-ran it than took it.',
  },
];

...
<section id="verified" class="sx-green">
  <div class="container">
    <SectionHead label={verified.label} title={verified.title} sub={verified.sub} prov={stamp} provUrl={ladder.results_doc_url} />
    ...
    <div class="verified-grid">
      <div>
        <div class="method-card">
          ...
          <p>
            {bench.methodology} <a class="link" href={verifiedAnchor} target="_blank" rel="noopener">What “verified” means</a> ·
            <a class="link" href={gateSrcUrl} target="_blank" rel="noopener">gate_results.py</a>
          </p>
        </div>
